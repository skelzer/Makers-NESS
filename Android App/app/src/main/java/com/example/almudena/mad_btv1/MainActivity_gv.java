...
public class MainActivity_gv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista1 = (GridView) findViewById(R.id.gridView);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.cnt_mnu_alarma:
                ...
                tpendingalarm = parseDate(Settings.System.getString(getContentResolver(), Settings.System.NEXT_ALARM_FORMATTED));
                ...
                m.getNextAlarmClock().getTriggerTime();*/

                StringRequest sPendingAlarm = new StringRequest(Request.Method.GET, "http://192.168.2.22:8080/Artik/alarm?id="+idpendingalarm+"&t="+tpendingalarm+"&a="+stpendingalarm, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.w("Alarma","works");
                    }
            ...
            case R.id.cnt_mnu_rename:
                ...
                View view = LayoutInflater.from(MainActivity_gv.this).inflate(R.layout.renamelayout, null);
                AlertDialog.Builder alertBuilder = new AlertDialog.Builder(MainActivity_gv.this);
...
// mId allows you to update the notification later on.
    ...
    void Notificacion(int resultado) {
        ...
        if (resultado == 1) {
            mBuilder = new NotificationCompat.Builder(ctx).setSound(RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION)).setSmallIcon(R.drawable.ic_action_reload).setAutoCancel(true).setContentTitle("Recirculación Completa").setContentText("La recirculación se ha completado, ya puedes utilizar el agua caliente sin desperdiciar ni una gota.");
        } else {
